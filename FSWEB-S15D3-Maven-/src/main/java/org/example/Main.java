...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        employees.add(new Employee(1, "EMRE", "UZUN"));
        employees.add(new Employee(1, "EMRE", "UZUN"));
        employees.add(new Employee(1, "EMRE", "UZUN"));
        employees.add(new Employee(2, "ZEYNEP", "BASTIK"));
        employees.add(new Employee(2, "ZEYNEP", "BASTIK"));
        employees.add(new Employee(3, "EMİN", "PALA"));
        employees.add(new Employee(4, "TÜLİN", "ÇİÇEK"));
